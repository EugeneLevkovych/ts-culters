...
const ProductItem = ({ product }: ProductProps) => {
  ...
  return (
    <div className="flex justify-between border-b border-gray13">
      <div className="flex p-4 lg:p-3">
        ...
        <div>
          ...
          <div
            className={`lg:hidden text-sm leading-[1.5] transition-all duration-300 ease-in-out ${
      ...
      <div
        ...
        className="w-8 h-7 flex justify-center items-center lg:hidden bg-gray13 rounded-lg m-4"
      >
        {!isOpen ? (
