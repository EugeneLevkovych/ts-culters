...
const Map = () => {
  return (
    <div className="p-5 bg-white rounded-3xl">
      ...
      <div className="flex gap-3 text-xs leading-[1.4] text-grey2 mb-7">
        <div className="flex items-center gap-1">
          <div className="size-3.5 bg-lime-green rounded-full"></div>
          <p>
            East Java <span className="font-bold text-grey7">(50%)</span>
          </p>
        </div>
        <div className="flex items-center gap-1">
          <div className="size-3.5 bg-blue2 rounded-full"></div>
          <p>
            Kalimantan <span className="font-bold text-grey7">(50%)</span>
          </p>
        </div>
        <div className="flex items-center gap-1">
          <div className="size-3.5 bg-blue3 rounded-full"></div>
          <p>
            Bali <span className="font-bold text-grey7">(65%)</span>
          </p>
        </div>
      </div>
